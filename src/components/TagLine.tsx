...
export const TagLine=()=>{
   const [choose, setChoose] = useState(false);
    return(
      ...
      <div className="bg-[url('/pic1.jpg')] h-[35rem] sm:w-[80%] w-full text-5xl text-gray-700 font-extrabold italic flex items-center justify-start  bg-center bg-cover rounded-b-lg">
          <div className="ml-10">
          Empowering Future Doctors, Enhancing HealthCare
          </div>
      </div>
      <div className="w-[95%] md:w-[75%] h-[25rem] rounded-lg  absolute top-[70%] overflow-hidden bg-gray-100">
