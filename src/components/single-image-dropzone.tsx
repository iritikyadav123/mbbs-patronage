      ...
      <div>
        ...
        >
          ...
          {imageUrl ? (
            ...
            // Upload Icon
            <div className="flex flex-col items-center justify-center text-xs object-cover object-center text-gray-400">
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        'border border-gray-600 bg-gray-500 text-gray-100 shadow hover:bg-gray-600',
        // size
