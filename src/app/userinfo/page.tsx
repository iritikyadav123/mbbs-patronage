  ...
  return (
    <div>
      ...
      <div className="w-full mt-10 mb-10 max-h-25rem flex flex-col items-center justify-center">
        <div className="text-center h-[10%] w-[90%] sm:w-[80%] text-3xl font-semibold mt-2 border-b-2 border-gray-400">Application Details</div>
        <div className="">
                     <img src={appData?.image} className="h-[10rem] w-[10rem] rounded-full mt-[5rem] mb-[5rem] ring-2"/> 
                   ...
                   <div className="font-medium text-xl flex items-center justify-center gap-5 w-[80%]">If you get scholarship, you can mark and review you application <button className="h-10 w-10 flex item-center justify-center border-2 border-black " onClick={()=>{setSection(!section)}}>{section == true && <img src={'/check.png'} className="h-8 w-8" />}</button></div>
                   ...
                   <div>
                      <Button onClick={handleSubmit} children="submit Review" className=""/>
                   </div>
        </div>
      </div>
    </div>
